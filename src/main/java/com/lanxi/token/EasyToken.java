...
//	}
	...
	public String sign() {
		return SignUtil.md5LowerCase(toPayload(),"utf-8");
	}
	@Override
	...
	public String toPayload(){
		if(hash==null||hash!=this.hashCode()){
			hash=this.hashCode();
			payStr=new String(SignUtil.base64En(SignUtil.desEn(priKey, toJson().getBytes())));
		}
		return payStr;
	}
	/**
...
//			String str=new String(bytes2);
			...
			String sign=SignUtil.md5LowerCase(strs[0],"utf-8");
			if(!sign.equals(strs[1]))
				return null;
			String jStr=new String(SignUtil.desDe(priKey,SignUtil.base64De(strs[0].getBytes())));
